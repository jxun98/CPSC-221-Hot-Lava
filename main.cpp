...
int main()
{
	...
	out3.writeToFile("images/sunshinePath.png");
	 ...
	 PNG origIm4;
	 origIm4.readFromFile("images/checkers.png");
	 pair<int,int> start4(4,5);
	 pair<int, int> end4(1000,500);
	 path chekers(origIm4, start4, end4);
	 PNG out4 = chekers.render();
	 out4.writeToFile("images/chekersPath.png");
